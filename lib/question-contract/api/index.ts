...
import type { BBoardDerivedState, BBoardContract, BBoardProviders, DeployedBBoardContract, PrivateStates, BBoardCircuitKeys } from './common-types';
import {
...
import { Witnesses } from '../contract';
...
export class BBoardAPI implements DeployedBBoardAPI {
   ...
   */
  static async deploy(providers: BBoardProviders,  title: string, logger?: Logger): Promise<BBoardAPI> {
